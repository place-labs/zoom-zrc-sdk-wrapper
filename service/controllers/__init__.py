...
__all__ = ['rooms_router', 'meetings_router', 'meeting_controls_router', 'meeting_list_router', 'meeting_share_router', 'meeting_video_router', 'meeting_view_layout_router', 'ndi_router', 'participant_router', 'phone_call_router']
