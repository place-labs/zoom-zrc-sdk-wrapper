...
Expected: **69 passed**. Needs only `pip install -r requirements-dev.txt`.
...
Expected: **75 passed** (69 unit + 6 smoke), 14 deselected (live).
...
The expected counts above are the baselines as of 1.6.0. If a change
